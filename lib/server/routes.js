  ...
  return function () {
    ...
    app.post('/user/changePassword', function (req, res, next) {
      var model = req.getModel()
        ...
        , schema = model.get('$user.schema')
        , errors = validators.changePassword.form(password, confirmPassword, schema);
    ...
    app.post('/user/resetPassword', function (req, res, next) {
      var model = req.getModel()
        ...
        , schema = model.get('$user.schema')
        , errors = validators.resetPassword.form(password, confirmPassword, schema);
