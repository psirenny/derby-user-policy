...
module.exports = function (app) {
  app.on('model', function (model) {
    ...
    model.fn('$validate.user.changePassword.currentPassword', validators.changePassword.currentPassword);
    ...
    model.fn('$validate.user.signin.password', validators.signin.password);
